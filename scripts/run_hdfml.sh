...
srun python training_swint_cla_rf_reg.py 
# srun python predicting_rf_reg.py --model_folder '/p/scratch/deepacf/deeprain/ji4/starter-pack/So2Sat_POP_model/cate_rf_reg'
# srun python training_rf_reg.py --model_folder '/p/scratch/deepacf/deeprain/ji4/starter-pack/So2Sat_POP_model/cate_rf_reg'
